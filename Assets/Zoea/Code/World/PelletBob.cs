...
namespace Zoea.World
{
    ...
    /// water rather than frozen. Purely decorative — no physics, no
    /// collision, no pickup logic.
    /// </summary>
    public class PelletBob : MonoBehaviour
    {
        ...
        [SerializeField] private float _swaySpeed = 0.4f;
        ...
        private void Awake()
        {
            ...
            // Without a random phase, every pellet in the scene bobs in
            // perfect unison, which reads as mechanical rather than organic.
